...
// ФУНКЦИЯ ДЛЯ АВТОМАТИЧЕСКОГО ПОИСКА ПАЦИЕНТА (аналогичная appointment_create.js)
...
function initializePatientSearch() {
    ...
    async function performSearch() {
        ...
        try {
            ...
            data.patients.forEach(patient => {
                ...
                item.querySelector('.use-patient-btn').addEventListener('click', (e) => {
                    e.stopPropagation();
                    // Используем ту же функцию selectPatient из автоматического поиска
                    selectPatient(patient);
                });
    ...
    // Используем функцию selectPatient из автоматического поиска
    // (она уже определена выше в initializeAutoPatientSearch)
